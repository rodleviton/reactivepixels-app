    ...
    return {
        ...
        controller: function($scope, $element, $attrs) {
            ...
            $timeout(function() {
                ...
                // scope.imageProcessRef.on('child_added', function(childSnapshot, prevChildName) {
                //     if (childSnapshot.val().id == $scope.token) {
                //         console.log('This is the image cropper');
                //     }
                // });
            });
            ...
            var CROP = (function () {
                ...
                return function () {
                    ...
                    */
                    ...
                    var coordinates = function coordinates(self) {
